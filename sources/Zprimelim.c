...
char*  name[8]={CDM[1],CDM[2],pdg2name(12),pdg2name(14),pdg2name(16),pdg2name(9912),pdg2name(9914),pdg2name(9916)};
char*  aname[8]={antiParticle(CDM[1]),antiParticle(CDM[2]),pdg2name(-12),pdg2name(-14),pdg2name(-16),pdg2name(-9912),pdg2name(-9914),pdg2name(-9916)};
...
char fname[300];
sprintf(fname, "%s/Data/dijetgrid.dat",micrO);
