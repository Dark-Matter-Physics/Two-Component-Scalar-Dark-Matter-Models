...
double R[18]={9.5,10.5,11.5,12.5,13.5,14.5,15.5,16.5,17.5,18.5,19.5,20.5,21.5,22.5,23.5,24.5,25.5,26.5};
double V[18]={221.75,223.32,220.72,222.92,224.16,221.60,218.79,216.38,213.48,209.17,206.25,202.54,197.56,197.00,191.62,187.12,181.44,175.68};
...
#ifdef DMPROFILE
// displayPlot("v(R)","R", 8.,26,0,1,"v",0,vv,NULL);   

   double vv(double r){ return polint1(r,18,R,V);}
   double integ(double r){ return pow(vv(r),2)/r;}
   
   double rc=26.5;   
  //rc=20;
   double vesc= sqrt(2*simpson(integ,8.2,rc,1e-3,NULL)+2*pow(vv(rc),2) );
...
// setProfileEinasto(0.17,Rsun);
// displayPlot("old profiles","R[kpc]", 0, 100,0,2,"NFW",0,hProfileZhao,NULL, "Einasto",0, hProfileEinasto,NULL);  
