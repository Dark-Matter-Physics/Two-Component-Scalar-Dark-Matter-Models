...
c ---------------- c
     ...
     .+)'
      ...
      if(brcharsnm1(1).ne.0d0) then
      write(nout,102) brcharsnm1(1),2,inmul,-imu,'BR(~chi_1+ -> ~nu_muL 
     .mu+)'
      endif
     ...
     .e)'
      ...
      if(brcharsmu1(1).ne.0d0) then
      write(nout,102) brcharsmu1(1),2,-ismul,inmu,'BR(~chi_1+ -> ~mu_L+ 
     .nu_mu)'
      endif
      if(brcharsmu2(1).ne.0d0) then
      write(nout,102) brcharsmu2(1),2,-ismur,inmu,'BR(~chi_1+ -> ~mu_R+ 
     .nu_mu)'
      endif
...
c ---------------- c
     ...
     .+)'
      ...
      if(brcharsnm1(2).ne.0d0) then
      write(nout,102) brcharsnm1(2),2,inmul,-imu,'BR(~chi_2+ -> ~nu_muL 
     .mu+)'
      endif
     ...
     .e)'
      ...
      if(brcharsmu1(2).ne.0d0) then
      write(nout,102) brcharsmu1(2),2,-ismul,inmu,'BR(~chi_2+ -> ~mu_L+ 
     .nu_mu)'
      endif
      if(brcharsmu2(2).ne.0d0) then
      write(nout,102) brcharsmu2(2),2,-ismur,inmu,'BR(~chi_2+ -> ~mu_R+ 
     .nu_mu)'
      endif
...
c ------------------ c
     ...
     ._R+     e-)'
      ...
      if(brneutsmu1(1).ne.0d0) then
      write(nout,102) brneutsmu1(1),2,ismul,-imu,      'BR(~chi_10 -> ~m
     .u_L-    mu+)'
      write(nout,102) brneutsmu1(1),2,-ismul,imu,      'BR(~chi_10 -> ~m
     .u_L+    mu-)'
      endif
      if(brneutsmu2(1).ne.0d0) then
      write(nout,102) brneutsmu2(1),2,ismur,-imu,      'BR(~chi_10 -> ~m
     .u_R-    mu+)'
      write(nout,102) brneutsmu2(1),2,-ismur,imu,      'BR(~chi_10 -> ~m
     .u_R+    mu-)'
      endif
     ...
     .u_eL*   nu_e )'
      ...
      if(brneutsnmu(1).ne.0d0) then
      write(nout,102) brneutsnmu(1),2,inmul,-inmu,     'BR(~chi_10 -> ~n
     .u_muL   nu_mub)'
      write(nout,102) brneutsnmu(1),2,-inmul,inmu,     'BR(~chi_10 -> ~n
     .u_muL*  nu_mu )'
      endif
...
c ------------------ c
     ...
     ._R+     e-)'
      ...
      if(brneutsmu1(2).ne.0d0) then
      write(nout,102) brneutsmu1(2),2,ismul,-imu,      'BR(~chi_20 -> ~m
     .u_L-    mu+)'
      write(nout,102) brneutsmu1(2),2,-ismul,imu,      'BR(~chi_20 -> ~m
     .u_L+    mu-)'
      endif
      if(brneutsmu2(2).ne.0d0) then
      write(nout,102) brneutsmu2(2),2,ismur,-imu,      'BR(~chi_20 -> ~m
     .u_R-    mu+)'
      write(nout,102) brneutsmu2(2),2,-ismur,imu,      'BR(~chi_20 -> ~m
     .u_R+    mu-)'
      endif
     ...
     .u_eL*   nu_e )'
      ...
      if(brneutsnmu(2).ne.0d0) then
      write(nout,102) brneutsnmu(2),2,inmul,-inmu,     'BR(~chi_20 -> ~n
     .u_muL   nu_mub)'
      write(nout,102) brneutsnmu(2),2,-inmul,inmu,     'BR(~chi_20 -> ~n
     .u_muL*  nu_mu )'
      endif
...
c ------------------ c
     ...
     ._R+     e-)'
      ...
      if(brneutsmu1(3).ne.0d0) then
      write(nout,102) brneutsmu1(3),2,ismul,-imu,      'BR(~chi_30 -> ~m
     .u_L-    mu+)'
      write(nout,102) brneutsmu1(3),2,-ismul,imu,      'BR(~chi_30 -> ~m
     .u_L+    mu-)'
      endif
      if(brneutsmu2(3).ne.0d0) then
      write(nout,102) brneutsmu2(3),2,ismur,-imu,      'BR(~chi_30 -> ~m
     .u_R-    mu+)'
      write(nout,102) brneutsmu2(3),2,-ismur,imu,      'BR(~chi_30 -> ~m
     .u_R+    mu-)'
      endif
     ...
     .u_eL*   nu_e )'
      ...
      if(brneutsnmu(3).ne.0d0) then
      write(nout,102) brneutsnmu(3),2,inmul,-inmu,     'BR(~chi_30 -> ~n
     .u_muL   nu_mub)'
      write(nout,102) brneutsnmu(3),2,-inmul,inmu,     'BR(~chi_30 -> ~n
     .u_muL*  nu_mu )'
      endif
...
c ------------------ c
     ...
     ._R+     e-)'
      ...
      if(brneutsmu1(4).ne.0d0) then
      write(nout,102) brneutsmu1(4),2,ismul,-imu,      'BR(~chi_40 -> ~m
     .u_L-    mu+)'
      write(nout,102) brneutsmu1(4),2,-ismul,imu,      'BR(~chi_40 -> ~m
     .u_L+    mu-)'
      endif
      if(brneutsmu2(4).ne.0d0) then
      write(nout,102) brneutsmu2(4),2,ismur,-imu,      'BR(~chi_40 -> ~m
     .u_R-    mu+)'
      write(nout,102) brneutsmu2(4),2,-ismur,imu,      'BR(~chi_40 -> ~m
     .u_R+    mu-)'
      endif
     ...
     .u_eL*   nu_e )'
      ...
      if(brneutsnmu(4).ne.0d0) then
      write(nout,102) brneutsnmu(4),2,inmul,-inmu,     'BR(~chi_40 -> ~n
     .u_muL   nu_mub)'
      write(nout,102) brneutsnmu(4),2,-inmul,inmu,     'BR(~chi_40 -> ~n
     .u_muL*  nu_mu )'
      endif
...
c ------------------ c
     ...
     ._R+     e-)'
      ...
      if(brneutsmu1(5).ne.0d0) then
      write(nout,102) brneutsmu1(5),2,ismul,-imu,      'BR(~chi_50 -> ~m
     .u_L-    mu+)'
      write(nout,102) brneutsmu1(5),2,-ismul,imu,      'BR(~chi_50 -> ~m
     .u_L+    mu-)'
      endif
      if(brneutsmu2(5).ne.0d0) then
      write(nout,102) brneutsmu2(5),2,ismur,-imu,      'BR(~chi_50 -> ~m
     .u_R-    mu+)'
      write(nout,102) brneutsmu2(5),2,-ismur,imu,      'BR(~chi_50 -> ~m
     .u_R+    mu-)'
      endif
...
c ------------------ c
      ...
      write(nout,102) brselrcharnue(1),2,-ic1,ine,'BR(~e_R- -> ~chi_1- 
     .nu_e)'
      endif
      if(brselrcharnue(2).ne.0d0) then
      write(nout,102) brselrcharnue(2),2,-ic2,ine,'BR(~e_R- -> ~chi_2- 
     .nu_e)'
      endif
...
c -------------- c
      write(nout,99)
      write(nout,100) ismul,smu1tot,'smuon_L'
      if(smu1tot2.ne.0d0) then
      write(nout,49) 'smuon_L 2-body decays'
      write(nout,101)
      if(brsmu1neutmu(1).ne.0d0) then
      write(nout,102) brsmu1neutmu(1),2,in1,imu,'BR(~mu_L- -> ~chi_10 mu
     .-)'
      endif
      if(brsmu1neutmu(2).ne.0d0) then
      write(nout,102) brsmu1neutmu(2),2,in2,imu,'BR(~mu_L- -> ~chi_20 mu
     .-)'
      endif
      if(brsmu1neutmu(3).ne.0d0) then
      write(nout,102) brsmu1neutmu(3),2,in3,imu,'BR(~mu_L- -> ~chi_30 mu
     .-)'
      endif
      if(brsmu1neutmu(4).ne.0d0) then
      write(nout,102) brsmu1neutmu(4),2,in4,imu,'BR(~mu_L- -> ~chi_40 mu
     .-)'
      endif
      if(brsmu1neutmu(5).ne.0d0) then
      write(nout,102) brsmu1neutmu(5),2,in5,imu,'BR(~mu_L- -> ~chi_50 mu
     .-)'
      endif
      if(brsmu1charnumu(1).ne.0d0) then
      write(nout,102) brsmu1charnumu(1),2,-ic1,inmu,'BR(~mu_L- -> ~chi_1
     .- nu_mu)'
      endif
      if(brsmu1charnumu(2).ne.0d0) then
      write(nout,102) brsmu1charnumu(2),2,-ic2,inmu,'BR(~mu_L- -> ~chi_2
     .- nu_mu)'
      endif
      if(brsmu1MUgra.ne.0d0) then
      write(nout,102) brsmu1MUgra,2,igrav,imu,'BR(~mu_L- -> ~gravitino m
     .u-)'
      endif
      endif
...
c-----------
      ...
      write(nout,103)
      if(brsmu1stau1star.ne.0d0) then
      write(nout,104) brsmu1stau1star,3,-istau1,imu,itau,
     .'BR(~mu_L- -> ~tau_1+ mu- tau-)'
      endif
      if(brsmu1stau1.ne.0d0) then
      write(nout,104) brsmu1stau1,3,istau1,imu,-itau,
     .'BR(~mu_L- -> ~tau_1- mu- tau+)'
      endif
      if(brsmu1stau1nutau.ne.0d0) then
      write(nout,104)brsmu1stau1nutau,3,istau1,inmu,-intau,
...
c ------------------ c
      write(nout,99)
      write(nout,100) ismur,smu2tot,'smuon_R'
      if(smu2tot2.ne.0d0) then
      write(nout,49) 'smuon_R 2-body decays'
      write(nout,101)
      if(brsmu2neutmu(1).ne.0d0) then
      write(nout,102) brsmu2neutmu(1),2,in1,imu,'BR(~mu_R- -> ~chi_10 mu
     .-)'
      endif
      if(brsmu2neutmu(2).ne.0d0) then
      write(nout,102) brsmu2neutmu(2),2,in2,imu,'BR(~mu_R- -> ~chi_20 mu
     .-)'
      endif
      if(brsmu2neutmu(3).ne.0d0) then
      write(nout,102) brsmu2neutmu(3),2,in3,imu,'BR(~mu_R- -> ~chi_30 mu
     .-)'
      endif
      if(brsmu2neutmu(4).ne.0d0) then
      write(nout,102) brsmu2neutmu(4),2,in4,imu,'BR(~mu_R- -> ~chi_40 mu
     .-)'
      endif
      if(brsmu2neutmu(5).ne.0d0) then
      write(nout,102) brsmu2neutmu(5),2,in5,imu,'BR(~mu_R- -> ~chi_50 mu
     .-)'
      endif
      if(brsmu2charnumu(1).ne.0d0) then
      write(nout,102) brsmu2charnumu(1),2,-ic1,inmu,'BR(~mu_R- -> ~chi_1
     .- nu_mu)'
      endif
      if(brsmu2charnumu(2).ne.0d0) then
      write(nout,102) brsmu2charnumu(2),2,-ic2,inmu,'BR(~mu_R- -> ~chi_2
     .- nu_mu)'
      endif
      if(brsmu2MUgra.ne.0d0) then
      write(nout,102) brsmu2MUgra,2,igrav,imu,'BR(~mu_R- -> ~gravitino m
     .u-)'
      endif
      endif
...
c-----------
      ...
      if(brsmu2stau1star.ne.0d0) then
      write(nout,104) brsmu2stau1star,3,-istau1,imu,itau,
     .'BR(~mu_R- -> ~tau_1+ mu- tau-)'
      endif
      if(brsmu2stau1.ne.0d0) then
      write(nout,104) brsmu2stau1,3,istau1,imu,-itau,
     .'BR(~mu_R- -> ~tau_1- mu- tau+)'
      endif
      if(brsmu2stau1nutau.ne.0d0) then
      write(nout,104)brsmu2stau1nutau,3,istau1,inmu,-intau,
...
c ---------------- c
      write(nout,99)
      write(nout,100) inmul,snmu1tot,'snu_muL'
      if(snmu1tot2.ne.0d0) then
      write(nout,49) 'snu_muL 2-body decays'
      write(nout,101)
      if(brsnmu1neut(1).ne.0d0) then
      write(nout,102) brsnmu1neut(1),2,in1,inmu,'BR(~nu_muL -> ~chi_10 n
     .u_mu)'
      endif
      if(brsnmu1neut(2).ne.0d0) then
      write(nout,102) brsnmu1neut(2),2,in2,inmu,'BR(~nu_muL -> ~chi_20 n
     .u_mu)'
      endif
      if(brsnmu1neut(3).ne.0d0) then
      write(nout,102) brsnmu1neut(3),2,in3,inmu,'BR(~nu_muL -> ~chi_30 n
     .u_mu)'
      endif
      if(brsnmu1neut(4).ne.0d0) then
      write(nout,102) brsnmu1neut(4),2,in4,inmu,'BR(~nu_muL -> ~chi_40 n
     .u_mu)'
      endif
      if(brsnmu1neut(5).ne.0d0) then
      write(nout,102) brsnmu1neut(5),2,in5,inmu,'BR(~nu_muL -> ~chi_50 n
     .u_mu)'
      endif
      if(brsnmu1char(1).ne.0d0) then
      write(nout,102) brsnmu1char(1),2,ic1,imu,'BR(~nu_muL -> ~chi_1+ mu
     .-)'
      endif
      if(brsnmu1char(2).ne.0d0) then
      write(nout,102) brsnmu1char(2),2,ic2,imu,'BR(~nu_muL -> ~chi_2+ mu
     .-)'
      endif
      if(brsnmNMgra.ne.0d0) then
...
c-----------
      ...
      write(nout,103)
      if(brsnmustau1star.ne.0d0) then
      write(nout,104) brsnmustau1star,3,inmu,-istau1,itau,
     .'BR(~nu_muL -> nu_mu ~tau_1+ tau-)'
      endif
      if(brsnmustau1.ne.0d0) then
      write(nout,104) brsnmustau1,3,inmu,istau1,-itau,
     .'BR(~nu_muL -> nu_mu ~tau_1- tau+)'
      endif
      if(brsnmustau1nutau.ne.0d0) then
      write(nout,104) brsnmustau1nutau,3,imu,-istau1,intau,
...
c ---------------- c
     ...
     .'BR(gravitino -> ~e_R+     e-     )'
      ...
      if(brgravm1.ne.0d0) then
      write(nout,102) brgravm1,2,ismul,-imu,
     .'BR(gravitino -> ~mu_L-    mu+    )'
      write(nout,102) brgravm1,2,-ismul,imu,
     .'BR(gravitino -> ~mu_L+    mu-    )'
      endif
      if(brgravm2.ne.0d0) then
      write(nout,102) brgravm2,2,ismur,-imu,
     ...
     .'BR(gravitino -> ~nu_eL*   nu_eb  )'
      ...
      if(brgravnm.ne.0d0) then
      write(nout,102) brgravnm,2,inmul,-inmu,
