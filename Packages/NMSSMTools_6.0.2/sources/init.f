...
*******************************************************************
      ...
      DOUBLE PRECISION GZMAX,GZINVMAX,MCHAMIN1,MCHAMIN2,MCMIN,SIGNEU1
      ...
      DOUBLE PRECISION HZH1(10000,3),HZH2(10000,3),HZH3(10000,3)
      DOUBLE PRECISION HZH4(10000,3),HHH(10000,3),HHH2(10000,3)
      ...
      COMMON/LEP/GZMAX,GZINVMAX,MCHAMIN1,MCHAMIN2,MCMIN,SIGNEU1,
     .      SIGNEU,MSLMIN,MSTMIN,MSQMIN,MGLMIN,
...
* Read CMS upper limit
* HAAMUS7(I,1): CP-odd Higgs mass
* HAAMUS7(I,2): upper limit on BR[H->2A]*BR[A->2mu]**2
      FILENAME=catpath(EXPCON_PATH,'2111.01299_5a1.dat')
      OPEN(11,FILE=FILENAME,STATUS='UNKNOWN',ERR=1)
      I=1
 9901 READ(11,*,END=9902,ERR=2)(HAAMUS7(I,J),J=1,2)
      I=I+1
      GOTO 9901
 9902 NHAAMUS7=I-1
      CLOSE(11)
      FILENAME=catpath(EXPCON_PATH,'2111.01299_5a2.dat')
      OPEN(11,FILE=FILENAME,STATUS='UNKNOWN',ERR=1)
      I=1
 9903 READ(11,*,END=9904,ERR=2)(HAAMUS8(I,J),J=1,2)
      I=I+1
      GOTO 9903
 9904 NHAAMUS8=I-1
      CLOSE(11)
