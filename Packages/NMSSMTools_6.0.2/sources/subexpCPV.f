...
*      PROB(25) =/= 0  stau too light
     ...
     . UMU(2,2,2)
      ...
      DOUBLE PRECISION GZMAX,GZINV,GZINVMAX,MCHAMIN1,MCHAMIN2,MCMIN
      DOUBLE PRECISION SIGNEU1,SIGNEU,MSLMIN,MSTMIN,MSQMIN,MGLMIN
...
* Test on chargino mass
      ...
      PROB(1)=DDIM(1d0,dsqrt(MCH2(1))/MCHAMIN1)
...
***********************************************************************
     ...
     . BRSUSY(5)
      DOUBLE PRECISION GZ,GZMAX,GZINVMAX,MCHAMIN1,MCHAMIN2,MCMIN
      DOUBLE PRECISION SIGNEU1,SIGNEU,MSLMIN,MSTMIN,MSQMIN,MGLMIN
      DOUBLE PRECISION hZind(1000,2),hZbb(1000,2),hZll(1000,2)
      DOUBLE PRECISION hZinv(1000,2),hZjj(1000,2),hZgg(1000,2)
      DOUBLE PRECISION hA4b(10000,3),hA4tau(10000,3)
