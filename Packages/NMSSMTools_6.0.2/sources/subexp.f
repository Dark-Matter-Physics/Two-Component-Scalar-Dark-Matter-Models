...
***********************************************************************
      ...
      INTEGER Nstblsn,Nstnc,Nsbnb,Nglsq,NMSFLAG
      ...
      DOUBLE PRECISION GZINV,GZINVMAX,MCHAMIN1,MCHAMIN2,MCMIN,SIGNEU1
      DOUBLE PRECISION SIGNEU,MSLMIN,MSTMIN,MSQMIN,MGLMIN,MMIN
...
* Test on chargino mass
      ...
      PROB(1)=DDIM(1d0,DABS(MCH(1))/MCHAMIN1)
      IF(NMSFLAG.EQ.1)THEN
       IF(brnupdb(1,1).GT.0.2d0)
     .  PROB(1)=DDIM(1d0,DABS(MCH(1))/MCHAMIN2)
      ENDIF
