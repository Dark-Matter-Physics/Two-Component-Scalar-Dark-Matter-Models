...
*      From [1',7',1910.12127=CMS,PDG]: 2.1 10^-9 < BR(Bs->mu+mu-) < 3.7 10^-9 (95% C.L.)
      BRBMUMUexpmax=3.7d-9
      BRBMUMUexpmin=2.1d-9

*      From [1',7',1910.12127]: BR(Bd->mu+mu-) < 0.36 10^-9 (95% C.L.)
      BRBdMUMUexpmax=0.36d-9
      BRBdMUMUexpmin=0d-9
...
*    RD from [11',PDG]
      RD_taulexpmin=0.35-2d0*0.04d0
      RD_taulexpmax=0.35+2d0*0.04d0

*    RD* from [11',PDG]
      RDs_taulexpmin=0.296-2d0*0.016d0
      RDs_taulexpmax=0.296+2d0*0.016d0
...
*      BR[B+ -> K+ nu nubar] from [1',15']
      ...
      BRBpKpnunuexpMax=min(1.6d-5,4.9d-5*tauB/tauB0)    ! comparing with bound 
                                                        ! from neutral decay
*      BR[B0 -> K0* nu nubar] from [1',16',1702.03224]
      BRBKsnunuexpMax=1.8d-5
      BRBKsnunuexpMax=min(1.8d-5,4d-5*tauB0/tauB)       ! comparing with bound 
                                                        ! from charged decay
