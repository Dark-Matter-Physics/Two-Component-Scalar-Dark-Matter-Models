...
* New June 2022
      AH2Pi=CDABS(MPI**2/2d0*(2d0/9d0*CJH-CU(IND)*dsqrt(dsqrt(2d0)*GF))
     c           *DCMPLX(-RFqqPiPiFit(MH),-IFqqPiPiFit(MH))/dsqrt(3d0) 
     c     +MPI**2/2d0*(2d0/9d0*CJH-CD(IND)*dsqrt(dsqrt(2d0)*GF))
     c           *DCMPLX(-RFqqPiPiFit(MH),-IFqqPiPiFit(MH))/dsqrt(3d0) 
     c     +(MK0**2+MKc**2-MPI**2)/2d0*(2d0/9d0*CJH-
     c                 CD(IND)*dsqrt(dsqrt(2d0)*GF))*dsqrt(2d0/3d0)
...
* New June 2022
      AHPiE=CDABS(MPI**2/2d0*(2d0/9d0*CJH-CU(IND)*dsqrt(dsqrt(2d0)*GF))
...
* New June 2022
      AH2K=CDABS(MPI**2/2d0*(2d0/9d0*CJH-CU(IND)*dsqrt(dsqrt(2d0)*GF))
     ...
     c                   -IFqqKKFit(MH)/2d0-IFudKKFit(MH)/dsqrt(2d0)) 
     c     +(MK0**2+MKc**2-MPI**2)/2d0*(2d0/9d0*CJH-
     c                   CD(IND)*dsqrt(dsqrt(2d0)*GF))/dsqrt(2d0)
...
* New June 2022
      AH2E=CDABS(MPI**2/2d0*(2d0/9d0*CJH-CU(IND)*dsqrt(dsqrt(2d0)*GF))
