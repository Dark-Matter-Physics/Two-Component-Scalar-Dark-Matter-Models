...
*********************************************************************
      ...
      DOUBLE PRECISION PAR(*),PROB(*),SIG(5,8),R,ggF13
     ...
     .      x,dNdx,EMIN,NBIN
      ...
      WRITE(16,930) 2,"6.0.1      # Version number"
     ...
     . WRITE(16,930) 4,"# No electroweak symmetry breaking"
      ...
      WRITE(16,906) "M1",SMASS(1)
      WRITE(16,906) "S1",SIG(1,3)
      WRITE(16,906) "S2",SIG(1,8)
      WRITE(16,906) "S3",SIG(1,2)
      WRITE(16,906) "M3",SMASS(3)
      WRITE(16,906) "S4",ggF13(SMASS(3))*CJ(3)**2*BRHHH(3)*BRBB(1)
     .                   *BRGG(2)
...
*  From IF(OUTFLAG.NE.1)
      ...
      WRITE(16,900) 2,"6.0.1      # Version number"
     ...
     . 'BR(t -> ~t_2 ~chi_50)'
      ...
      WRITE(17,900) 2,"6.0.1      # Version number"
      IF(PROB(30).GT.0d0)
